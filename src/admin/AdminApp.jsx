  ...
  return (
    ...
    >
      <div style={{ position: "absolute", inset: 0, zIndex: 0 }}>
        <img
          src="/src/assets/images/ph-beach.jpg"
          alt=""
      ...
      <div
        style={{
          ...
          inset: 0,
          zIndex: 1,
          backgroundColor: "hsla(219,33%,43%,0.40)",
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <img
                src="/src/assets/logos/AIESEC-white.png"
                alt="AIESEC PH"
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                boxShadow: "5px 5px 0 0 " + BRAND.yellow,
              ...
              onMouseLeave={(e) => {
                ...
                e.currentTarget.style.boxShadow = "5px 5px 0 0 " + BRAND.yellow;
              }}
            >
    ...
    >
      ...
      >
        ...
        <button
          ...
          onMouseEnter={(e) =>
            (e.currentTarget.style.backgroundColor = BRAND.indigo)
          }
          onMouseLeave={(e) =>
    ...
    >
      ...
      >
        ...
        <nav
          style={{
            flex: 1,
            padding: sidebarOpen ? "10px 8px" : "10px 6px",
            display: "flex",
            flexDirection: "column",
            gap: 3,
            overflowY: "auto",
                ...
                onMouseEnter={(e) => {
                  if (!active) {
                    e.currentTarget.style.backgroundColor =
                      "rgba(49,39,131,0.08)";
                    e.currentTarget.style.color = BRAND.indigo;
                  }
                }}
                onMouseLeave={(e) => {
                  if (!active) {
                    e.currentTarget.style.backgroundColor = "transparent";
                    e.currentTarget.style.color = "#5c4b00";
                  }
                }}
              >
